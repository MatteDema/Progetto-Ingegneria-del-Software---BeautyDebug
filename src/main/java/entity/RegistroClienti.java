...
public class RegistroClienti {
    ...
    boolean registrazione(String email){
        // nella prima parte della registrazione l'utente inserisce i dati fino alla email
        // il sistema verifica che non sia già presente, cioè associata a un altro cliente
